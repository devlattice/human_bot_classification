...
Examples (repo root):
  ...
  PYTHONPATH=. python .../sanity_check.py --data-dir workspace/dataset/.../system_bot \\
    --out-csv workspace/preprocess/statistical_test/explorer/miner_1/feature_1/scripts/sanity_report.csv
  ...
  --out-csv workspace/preprocess/statistical_test/explorer/miner_1/feature_1/scripts/sanity_report.csv \
  --out-json workspace/preprocess/statistical_test/explorer/miner_1/feature_1/scripts/sanity_summary.json    
"""
